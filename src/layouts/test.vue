...
:class="$style.headerImg"
            ...
            <div :class="$style.headerActionContainer">
                <div :class="$style.headerSearch">
                    <form
:class="$style.headerSearchForm" @click="handleInputClick"
                        ...
                        <div :class="$style.headerSearchLeft">
                            ...
                            <input
id="" type="text" name="" :class="$style.headerSearchInput"
        ...
        <div :class="$style.navTree">
            ...
            <div :class="[$style.navItemDrive, $style.navItem]">
                ...
                <div :class="[$style.navItemDriveIc, $style.navItemIc]">
                    <svg
class=" c-qd" width="1.25rem" height="1.25rem" viewBox="0 0 24 24" fill="##292929"
                        focusable="false">
                        <path
